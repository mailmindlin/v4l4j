...
abstract class AbstractGrabber implements FrameGrabber {
	 ...
	 * 
	 * @param di
	 *            the DeviceInfo object associated with the video device who
	 ...
	 * @param ty
	 *            the output image format, ie the type of this frame grabber:
	 *            {@link #RAW_GRABBER}, {@link #JPEG_GRABBER},
	 *            {@link #RGB24_GRABBER}, {@link #BGR24_GRABBER},
	 *            {@link #YUV_GRABBER}, {@link #YVU_GRABBER}
	 * @param factory
	 *            the {@link ThreadFactory} to use when creating new threads
	 ...
	 *             for a raw frame grabber, this exception is thrown if the
	 *             chosen Image format is unsupported.
	 ...
	 *             if the frame grabber is already initialised
	 * @throws V4L4JException
	 ...
	 * 
	 * @throws StateException
	 *             if if this <code>FrameGrabber</code> has been already
