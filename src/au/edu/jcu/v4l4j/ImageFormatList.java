 ...
 * native (or raw) format is a format supported and used by the driver. This
 * native format list is obtained by calling {@link #getNativeFormats()}.
 * Additionally, v4l4j can convert some native formats to RGB24, BGR24, JPEG,
 * YUV420 and YVU420. The {@link #getRGBEncodableFormats()},
 * {@link #getBGREncodableFormats()}, {@link #getJPEGEncodableFormats()},
 * {@link #getYUVEncodableFormats()} & {@link #getYVUEncodableFormats()} methods
 * returns the subset of native formats that can be converted to these formats.
 * <code>ImageFormatList</code>s are not directly instantiated. Instead, you can
 * get the list of {@link ImageFormat}s supported by a {@link VideoDevice} by
 * calling {@link DeviceInfo#getFormatList()} on its associated
 * {@link DeviceInfo}.
 * 
 * @author gilles
 *
...
public class ImageFormatList {
	 ...
	 * {@link #YVU420formats} members, given a v4l4j_device. This method must be
	 * called while the device info interface of libvideo is checked out.
	 * 
	 * @param object
	 *            a JNI pointer to a struct v4l4j_device with the device info
	 *            interface of libvideo checked out
	 */
	...
	/**
	 * This method builds a list of {@link ImageFormat}s. This method must be
	 * called while the device info interface of libvideo is checked out.
	 * 
	 * @param o
	...
	/**
	 * This method moves the given image format <code>format</code> in the first
	 * position of the vector.
	 * 
	 * @param v
	 *            the vector if image format
	 * @param format
	 *            the index of the format to be moved in first position
	 */
	...
	/**
	 * This method looks for a native {@link ImageFormat} in this list given its
	 * name, and returns it, or <code>null</code> if not found.
	 * 
	 * @param n
	 *            the name of the <code>ImageFormat</code>.
	...
	/**
	 * This method looks for a native {@link ImageFormat} given its index, and
	 * returns it, or <code>null</code> if not found. A list of all known format
	 * indexes can be found in {@link V4L4JConstants}.IMF_*.
	 * 
	 * @param i
	 *            the index of the <code>ImageFormat</code> to look up
	 * @return the <code>ImageFormat</code> or <code>null</code> if not found.
	 */
	...
	/**
	 * This method returns a list of native {@link ImageFormat}s contained in
	 * this object, that can be converted to JPEG by v4l4j. The list is sorted:
	 * image formats better suited for the conversion are listed first.
	 * 
	 * @return a list of {@link ImageFormat}s contained in this object, that can
	...
	/**
	 * This method looks for a native {@link ImageFormat} that can be converted
	 * to JPEG by v4l4j given its index, and returns it, or <code>null</code> if
	 * not found. A list of all known format indexes can be found in
	...
	/**
	 * This method returns a list of native {@link ImageFormat}s contained in
	 * this object, that can be converted to RGB24 by v4l4j. The list is sorted:
	 * image formats better suited for the conversion are listed first.
	 * 
	 * @return a list of {@link ImageFormat}s contained in this object, that can
	...
	/**
	 * This method returns a list of native {@link ImageFormat}s contained in
	 * this object, that can be converted to BGR24 by v4l4j. The list is sorted:
	 * image formats better suited for the conversion are listed first.
	 * 
	 * @return a list of {@link ImageFormat}s contained in this object, that can
	...
	/**
	 * This method looks for a native {@link ImageFormat} that can be converted
	 * to BGR24 by v4l4j given its index, and returns it, or <code>null</code>
	 * if not found. A list of all known format indexes can be found in
	 * {@link V4L4JConstants}.IMF_* .
	 * 
	 * @param i
	...
	/**
	 * This method returns a list of native {@link ImageFormat}s contained in
	 * this object, that can be converted to YUV420 by v4l4j. The list is
	...
	/**
	 * This method looks for a native {@link ImageFormat} that can be converted
	 * to YUV420 by v4l4j in this list given its name, and returns it, or
	 * <code>null</code> if not found.
	 * 
	 * @param n
	 *            the name of the <code>ImageFormat</code>.
	...
	/**
	 * This method looks for a native {@link ImageFormat} that can be converted
	 * to YUV420 by v4l4j given its index, and returns it, or <code>null</code>
	 * if not found. A list of all known format indexes can be found in
	 * {@link V4L4JConstants}.IMF_* .
	 * 
	 * @param i
	...
	/**
	 * This method returns a list of native {@link ImageFormat}s contained in
	 * this object, that can be converted to YVU420 by v4l4j. The list is
	 * sorted: image formats better suited for the conversion are listed first.
	 * 
	 * @return a list of {@link ImageFormat}s contained in this object, that can
	...
	/**
	 * This method looks for a native {@link ImageFormat} that can be converted
	 * to YVU420 by v4l4j in this list given its name, and returns it, or
	 * <code>null</code> if not found.
	 * 
	 * @param n
	 *            the name of the <code>ImageFormat</code>.
	...
	/**
	 * This method looks for a native {@link ImageFormat} that can be converted
	 * to YVU420 by v4l4j given its index, and returns it, or <code>null</code>
	 * if not found. A list of all known format indexes can be found in
