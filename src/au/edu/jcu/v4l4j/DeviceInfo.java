...
public class DeviceInfo {
	 ...
	 * 
	 * @param f
	 *            the full path to the V4L device file
	 */
	 ...
	 * 
	 * @param o
	 *            a JNI pointer to a struct v4l4j_device
	 * @param imf
	 *            the libvideo image format
	 * @param w
	 *            the capture width
	 * @param h
	 *            the capture height
	 ...
	 *             if the associated VideoDevice has been released
	 */
	 ...
	 * @param imf
	 *            the capture image format for which the frame intervals should
	 *            be enumerated
	 * @param width
	 *            the capture width for which the frame intervals should be
	 *            enumerated
	 * @param height
	 *            the capture height for which the frame intervals should be
	 *            enumerated
	 * @throws StateException
	 *             if the associated VideoDevice has been released
	 */
	 ...
	 *             if there is an error retrieving information from the video
	 *             device.
	 */
	 ...
	 * 
	 * @throws StateException
	 *             if this object has been released
	 */
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((deviceFile == null) ? 0 : deviceFile.hashCode());
		return result;
	}
