 ...
 * retrieve images in a native format. A BGR24 frame grabber can only be created 
 ...
 *
 */
public class BGRFrameGrabber extends FrameGrabber {
	 ...
	 */
	BGRFrameGrabber(VideoDevice vd, long o, int w, int h, int ch, int std, 
			Tuner t,ImageFormat imf) throws ImageFormatException {
		super(vd, o, w, h, ch, std, t, imf, BGR24_GRABBER);
	}
	...
	public ImageFormat getImageFormat(){
		try {
			return vdev.getDeviceInfo().getFormatList().getBGREncodableFormat(format);
