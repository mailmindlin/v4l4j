 ...
 * <li>The supported standards ({@link V4L4JConstants#STANDARD_PAL},
 * {@link V4L4JConstants#STANDARD_SECAM}, {@link V4L4JConstants#STANDARD_NTSC}
 * or {@link V4L4JConstants#STANDARD_WEBCAM})</li>
...
public class InputInfo {
	...
	/**
	 * A set of the supported standards ({@link V4L4JConstants#STANDARD_PAL},
	 * {@link V4L4JConstants#STANDARD_SECAM},
	 * {@link V4L4JConstants#STANDARD_NTSC} or
	...
	/**
	 * This constructor builds an Input object representing a physical input on
	 * the V4L video device.
	 * 
	 * @param n
	...
	/**
	 * This constructor builds an Input object representing a TUNER input on the
	 * V4L video device.
	 * 
	 * @param n
	 *            the name of the input
	 ...
	 *            the supported standards
	 * @param tun
	 *            the tuner associated with this input
	 */
	...
	/**
	 * This constructor builds an Input object representing a CAMERA input on
	 * the V4L video device.
	 * 
	 * @param n
	 *            the name of the input
	 ...
	 * {@link V4L4JConstants#INPUT_TYPE_TUNER} or
	 * {@link V4L4JConstants#INPUT_TYPE_CAMERA})
	 * 
	 ...
	 * {@link V4L4JConstants#STANDARD_PAL},
	 * {@link V4L4JConstants#STANDARD_SECAM},
	 * {@link V4L4JConstants#STANDARD_NTSC} or
	 * {@link V4L4JConstants#STANDARD_WEBCAM})
	 * 
	...
	/**
	 * This method returns the {@link TunerInfo} associated with this input, if
	 * any.
	 * 
	 * @return the tuner
	 * @throws NoTunerException
	 *             if this input is of type
	...
	/**
	 * This method returns a boolean depending on whether this input has a tuner
	 * or not.
	 * 
