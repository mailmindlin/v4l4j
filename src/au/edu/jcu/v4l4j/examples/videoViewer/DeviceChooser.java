...
public class DeviceChooser extends WindowAdapter implements ActionListener {
			...
			if (e.getSource() instanceof JComboBox) {
				...
				if (b.getText().equals(CTRL_ONLY_STR))
					...
					if (b.getText().indexOf(RGB_BUTTON_STR) != -1) {
						...
						try {
							new JPEGViewer(vd, chooser.width, chooser.height, std, channel, 80);
						} catch (V4L4JException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}
	...
	public static void main(String[] args) {
		...
		final int w = (System.getProperty("test.width") != null) ? Integer.parseInt(System.getProperty("test.width"))
				: 640;
		final int h = (System.getProperty("test.height") != null) ? Integer.parseInt(System.getProperty("test.height"))
				: 480;
