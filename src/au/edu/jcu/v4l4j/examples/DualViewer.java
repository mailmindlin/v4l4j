...
/**
 * This class creates a JFrame with two JLabels, and displays streams from two
 * VideoDevices
 * 
 * @author gilles
 *
...
public class DualViewer extends WindowAdapter implements CaptureCallback {
	 ...
	 * 
	 * @param devLeft
	 *            the video device file to capture from, which will be displayed
	 *            on the left
	 * @param devRight
	 *            the video device file to capture from, which will be displayed
	 *            on the right
	 ...
	 */
	private void initFrameGrabber(String devLeft, String devRight, int w, int h, int std, int channel, int qty)
			throws V4L4JException {
