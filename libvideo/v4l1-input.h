...
void *dequeue_buffer_v4l1(struct video_device *device, unsigned int *len, unsigned int *index, struct timeval* timestamp, unsigned long long* sequence) __attribute__((nonnull (1, 2, 3)));
