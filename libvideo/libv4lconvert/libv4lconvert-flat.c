...
typedef struct {
	int id;
	enum {swwh_0f, sdwh_1f, sd_sf_1f, sd_sf_2f} fingerprint;
...
struct v4lconvert_encoder {
	...
	v4lconvert_converter* converter;
	u32 width;
	u32 height;
};
...
#define GENERATE_CONVERTER_SD_SF_1F(id, fn, src_fmt, dst_fmt, flag1) {.id = id, .fingerprint = fingerprint_sd_sf_1f, .target.cvt_sd_sf_2f = (fn), .src_fmt = (src_fmt), .dst_fmt = (dst_fmt), .flag1 = flag1, .flag2 = NULL}
...
v4lconvert_converter v4lconvert_converters[10] = {
